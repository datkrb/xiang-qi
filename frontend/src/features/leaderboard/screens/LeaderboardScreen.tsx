    ...
    return (
      <PageContainer maxWidth="4xl">
        <Button
          variant="secondary"
          onClick={onBack}
          className="mb-8 font-semibold flex items-center gap-2"
        >
          <ArrowLeft className="w-5 h-5" />
          <span>Back to Menu</span>
        </Button>

        <Card variant="elevated" padding="lg" className="rounded-3xl space-y-8">
          <div className="flex items-center justify-between border-b border-border pb-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <Text variant="h1" className="text-4xl tracking-tight">
                  Leaderboard
                </Text>
              ...
              return (
                <div
                  ...
                  className={`flex flex-col sm:flex-row items-start sm:items-center justify-between p-5 rounded-2xl border transition-all duration-300 hover:scale-[1.01] ${
                    player.rank === 1
                      ? "bg-surface-interactive border-primary shadow-[0_0_15px_rgba(14,165,233,0.2)]"
